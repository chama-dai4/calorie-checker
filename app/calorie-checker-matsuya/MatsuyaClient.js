...
const GROUPS = [
  {
    id: "main",
    labelKey: "group.matsuyaMain",
    categories: ["丼", "カレー", "定食"],
  },
  {
    id: "morning",
    labelKey: "group.matsuyaMorning",
    categories: ["朝定食"],
  },
  {
    id: "side",
    labelKey: "group.matsuyaSide",
    categories: ["サイドメニュー", "ご飯・ドレッシング", "お子様セット", "デザート"],
  },
  {
    id: "drink",
    labelKey: "group.matsuyaDrink",
    categories: ["ドリンク"],
  },
  {
    id: "limited",
    labelKey: "group.matsuyaLimited",
    categories: ["店舗限定"],
  },
];
...
export default function MatsuyaClient({ menus, locale = "ja" }) {
  ...
  // チェーン名の表示
  const chainDisplayName = tChain("松屋") || "松屋";
  ...
  const groupLabel = (g) => {
    ...
    const fallback = {
      main: { ja: "主食", en: "Main" },
      morning: { ja: "朝メニュー", en: "Morning" },
      side: { ja: "サイド", en: "Sides" },
      drink: { ja: "ドリンク", en: "Drinks" },
      limited: { ja: "店舗限定", en: "Limited" },
    };
      ...
      <div className={styles.wrapper}>
        <header className={styles.header}>
          ...
          <p className={styles.subtitle}>
            {t("chain.subtitleMatsuya") !== "chain.subtitleMatsuya"
              ? t("chain.subtitleMatsuya")
              : "牛めし・カレー・定食も。松屋の全メニューを選ぶだけで、合計カロリーとPFC（たんぱく質・脂質・炭水化物）を瞬時に算出。サイズ選択とアレルゲン情報にも対応しています。"}
          </p>
        </header>
        ...
        <div className={styles.allergyNotice}>
          ...
          <a href="https://www.matsuyafoods.co.jp/" target="_blank" rel="noopener">{locale === "en" ? "Matsuya " : "松屋"}{t("chain.officialSite")}</a>
        ...
        <div className={styles.mainLayout}>
          <div className={styles.leftCol}>
            ...
            <div className={styles.pageFooter}>
              {t("chain.disclaimerPrefix")}<a href="https://www.matsuyafoods.co.jp/" target="_blank" rel="noopener">{locale === "en" ? "Matsuya " : "松屋"}{t("chain.officialSite")}</a>{t("chain.disclaimerSuffix")}<br />
              {t("chain.matsuyaDisclaimerAffiliation") !== "chain.matsuyaDisclaimerAffiliation"
                ? t("chain.matsuyaDisclaimerAffiliation")
                : "※当サイトは株式会社松屋フーズおよび松屋とは一切関係のない非公式のカロリー計算ツールです。"}
            </div>
          </div>
