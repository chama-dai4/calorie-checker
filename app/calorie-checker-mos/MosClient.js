...
const GROUPS = [
  {
    id: "main",
    labelKey: "group.main",
    categories: ["ハンバーガー", "とびきりバーガー", "ソイパティ", "モスの菜摘", "モスライス/ホットドッグ", "朝モス", "モスワイワイセット", "低アレルゲン"],
  },
  {
    id: "side",
    labelKey: "group.side",
...
export default function MosClient({ menus, locale = "ja" }) {
  ...
  // チェーン名の表示（英語版は併記）
  const chainDisplayName = tChain("モスバーガー");
        ...
        <div className={styles.mainLayout}>
          <div className={styles.leftCol}>
            ...
            <div className={styles.pageFooter}>
              {t("chain.disclaimerPrefix")}<a href="https://www.mos.jp/" target="_blank" rel="noopener">{locale === "en" ? "Mos Burger Japan " : "モスバーガー"}{t("chain.officialSite")}</a>{t("chain.disclaimerSuffix")}<br />
              {t("chain.disclaimerAffiliation")}{locale === "en" ? "Mos Burger Japan" : "モスバーガー"}{t("chain.disclaimerAffiliationSuffix")}
            </div>
          </div>
