...
export default function MosClient({ menus }) {
        ...
        <div className={styles.mainLayout}>
          <div className={styles.leftCol}>
            ...
            <div className={styles.pageFooter}>
              数値は <a href="https://www.mos.jp/" target="_blank" rel="noopener">モスバーガー公式サイト</a> の成分情報を参照した参考値です。<br />
              本サービスはモスバーガーと提携・関係ありません。最新かつ正確な情報は公式サイトをご確認ください。
            </div>
          </div>
