...
const GROUPS = [
  {
    id: "main",
    labelKey: "group.nakauMain",
    categories: ["丼", "カレー"],
  },
  {
    id: "noodle",
    labelKey: "group.nakauNoodle",
    categories: ["麺類"],
  },
  {
    id: "set",
    labelKey: "group.nakauSet",
    categories: ["定食", "朝食"],
  },
  {
    id: "side",
    labelKey: "group.nakauSide",
    categories: ["サイドメニュー", "ご飯・ドレッシング", "お子様セット"],
  },
  {
    id: "drink",
    labelKey: "group.nakauDrink",
    categories: ["ドリンク"],
  },
];
...
export default function NakauClient({ menus, locale = "ja" }) {
  ...
  // チェーン名の表示
  const chainDisplayName = tChain("なか卯") || "なか卯";
  ...
  const groupLabel = (g) => {
    ...
    const fallback = {
      ...
      noodle: { ja: "麺類", en: "Noodles" },
      set: { ja: "定食・朝食", en: "Meals & Breakfast" },
      ...
      <div className={styles.wrapper}>
        <header className={styles.header}>
          ...
          <p className={styles.subtitle}>
            {t("chain.subtitleNakau") !== "chain.subtitleNakau"
              ? t("chain.subtitleNakau")
              : "丼・京風うどん・定食も。なか卯の全メニューを選ぶだけで、合計カロリーとPFC（たんぱく質・脂質・炭水化物）を瞬時に算出。サイズ選択とアレルゲン情報にも対応しています。"}
          </p>
        </header>
        ...
        <div className={styles.allergyNotice}>
          ...
          <a href="https://www.nakau.co.jp/" target="_blank" rel="noopener">{locale === "en" ? "Nakau " : "なか卯"}{t("chain.officialSite")}</a>
        ...
        <div className={styles.mainLayout}>
          <div className={styles.leftCol}>
            ...
            <div className={styles.pageFooter}>
              {t("chain.disclaimerPrefix")}<a href="https://www.nakau.co.jp/" target="_blank" rel="noopener">{locale === "en" ? "Nakau " : "なか卯"}{t("chain.officialSite")}</a>{t("chain.disclaimerSuffix")}<br />
              {t("chain.nakauDisclaimerAffiliation") !== "chain.nakauDisclaimerAffiliation"
                ? t("chain.nakauDisclaimerAffiliation")
                : "※当サイトは株式会社なか卯および「なか卯」とは一切関係のない非公式のカロリー計算ツールです。"}
            </div>
          </div>
