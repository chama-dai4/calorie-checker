...
const GROUPS = [
  {
    id: "hamburg",
    labelKey: "group.gustoHamburg",
    categories: ["ハンバーグ・ステーキ"],
  },
  {
    id: "pasta",
    labelKey: "group.gustoPasta",
    categories: ["パスタ・洋食"],
  },
  {
    id: "washoku",
    labelKey: "group.gustoWashoku",
    categories: ["和食・丼・麺"],
  },
  {
    id: "salad",
    labelKey: "group.gustoSalad",
    categories: ["サラダ・サイド"],
  },
  {
    id: "morning",
    labelKey: "group.gustoMorning",
    categories: ["モーニング"],
  },
  {
    id: "dessert",
    labelKey: "group.gustoDessert",
    categories: ["デザート・ドリンク"],
  },
  {
    id: "kids",
    labelKey: "group.gustoKids",
    categories: ["キッズ"],
  },
];
...
export default function GustoClient({ menus, locale = "ja" }) {
  ...
  const [activeGroup, setActiveGroup] = useState("hamburg");
  ...
  const groupLabel = (g) => {
    ...
    // フォールバック(日本語 / 英語)
    const fallback = {
      hamburg: { ja: "ハンバーグ・ステーキ", en: "Hamburg & Steak" },
      pasta: { ja: "パスタ・洋食", en: "Pasta & Western" },
      washoku: { ja: "和食・丼・麺", en: "Japanese & Noodles" },
      salad: { ja: "サラダ・サイド", en: "Salad & Sides" },
      ...
      <div className={styles.wrapper}>
        <header className={styles.header}>
          ...
          <p className={styles.subtitle}>
            {t("chain.subtitleGusto") !== "chain.subtitleGusto"
              ? t("chain.subtitleGusto")
              : "ハンバーグ・ステーキ・パスタ・モーニングも。ガストの全メニューを選ぶだけで合計カロリーを瞬時に算出。アレルゲン情報も一目で確認できます。"}
          </p>
        </header>
        ...
        <div className={styles.allergyNotice}>
          ...
          <a href="https://www.skylark.co.jp/gusto/" target="_blank" rel="noopener">{locale === "en" ? "Gusto " : "ガスト"}{t("chain.officialSite")}</a>
        ...
        <div className={styles.mainLayout}>
          <div className={styles.leftCol}>
            ...
            <div className={styles.pageFooter}>
              {t("chain.disclaimerPrefix")}<a href="https://www.skylark.co.jp/gusto/" target="_blank" rel="noopener">{locale === "en" ? "Gusto " : "ガスト"}{t("chain.officialSite")}</a>{t("chain.disclaimerSuffix")}<br />
              {t("chain.gustoDisclaimerAffiliation") !== "chain.gustoDisclaimerAffiliation"
                ? t("chain.gustoDisclaimerAffiliation")
                : "※当サイトは株式会社すかいらーくホールディングスおよびガストとは一切関係のない非公式のカロリー計算ツールです。"}
            </div>
          </div>
