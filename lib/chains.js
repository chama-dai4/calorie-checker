...
export const CATEGORIES = [
  ...
  },
  {
    ...
    chains: [
      ...
      { name: 'ドトールコーヒーショップ', href: '/calorie-checker-doutor', available: true },
      ...
      { name: 'カフェベローチェ', href: '/calorie-checker-veloce', available: true },
    ],
  },
  {
    slug: 'pizza',
    ...
    chains: [
      ...
      { name: 'ドミノ・ピザ', href: '/calorie-checker-domino', available: true },
  ...
  },
  {
    ...
    chains: [
      ...
      { name: '天丼てんや', href: '/calorie-checker-tenya', available: true },
    ],
  },
  {
    slug: 'sushi',
    ...
    chains: [
      ...
      { name: 'スシロー', href: '/calorie-checker-sushiro', available: true },
  ...
  },
  {
    ...
    chains: [
      ...
      { name: '大戸屋', href: '/calorie-checker-ootoya', available: true },
    ],
  },
  {
    slug: 'famires',
  ...
  },
  {
    ...
    nameEn: 'Udon & Soba',
    iconName: 'Soup',
    description: 'うどん・そばチェーン',
    descriptionEn: 'Udon and soba chains in Japan',
    chains: [
      { name: 'はなまるうどん', href: '/calorie-checker-hanamaru', available: true },
      { name: '丸亀製麺', href: '/calorie-checker-marugame', available: true },
      { name: 'ゆで太郎', href: null, available: false },
      { name: '富士そば', href: null, available: false },
    ],
  },
];
